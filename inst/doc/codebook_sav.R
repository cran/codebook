...
## -----------------------------------------------------------------------------
darktriad_path <- system.file("extdata", "darktriad.sav", package = "codebook")
darktriad <- rio::import(darktriad_path, format = "sav")
if (!knit_by_pkgdown) {
  darktriad <- darktriad %>%
...
### Original source
[Open Science Framework](https://osf.io/j4fcb/)
